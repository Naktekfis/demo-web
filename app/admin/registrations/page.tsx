          ...
          {data.items.length === 0 ? (
            ...
            data.items.map((registration) => (
              <div key={registration.id} className="grid gap-4 border-b border-slate-100 px-5 py-5 last:border-0 lg:grid-cols-12">
                ...
                <div className="lg:col-span-1"><span className="rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold capitalize text-slate-700">{registration.status}</span></div>
                <div className="lg:col-span-3">
